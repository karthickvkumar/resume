            ...
            var ImageCropper = (function () {
                ...
                ImageCropper.prototype.setImage = function (img) {
                    ...
                    if (cropAspect > sourceAspect) {
                        ...
                        PointPool.instance.returnPoint(blPos);
                        PointPool.instance.returnPoint(brPos);
                        console.info(tlPos,trPos,blPos,brPos)
                    }
                ...
                ImageCropper.prototype.getCroppedImage = function (fillWidth, fillHeight) {
                    ...
                    /*customized*/
                    var ImgIsExist = $rootScope.checkOldCollageImg
                    if(ImgIsExist){
                    
                    }else{
                        $rootScope.collageOnFly(this.croppedImage.src, this.canvas.id, this.srcImage.src, bounds);
                    }
                ...
                ImageCropper.prototype.move = function (cropTouch, e) {
                    if (this.isMouseDown) {
                        $rootScope.checkOldCollageImg = false;
